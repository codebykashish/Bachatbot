...
→ \"Thik cha, ke garnu? Expense track garne, budget set garna, ki report herne?\"
...
def parse_ai_response(response_text: str) -> list:
    """
    Extract the DATA[...]DATA block from AI's response.
    ...
    if array_match:
        try:
            ...
            print(f"[AI PARSE] Array parse failed: {e}")
    ...
    if obj_match:
        try:
            ...
            print(f"[AI PARSE] Object parse failed: {e}")
